...
const quizEngine = {
     ...
     * two indices, with a HTML element ID stored at each index, for each corresponding question. 
     * This method retrieves the ID, and then accesses that element in the DOM to
